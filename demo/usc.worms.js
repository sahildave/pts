...
(function() {
	...
	run((time, ftime) => {
		...
		form.fill(Color.from(255, 0, 0, alpha).toString("rgba")).polygon(Curve.bspline(uOuter , 10, 1));
        ...
        form.fill(Color.from(0, 255, 0, alpha).toString("rgba")).polygon(Curve.bspline(cOuter , 10, 1));
        ...
        form.fillOnly("rgb(255,255,0)").polygon(Curve.bspline( uGroup, 10, 1));
		...
		scGroup.insert( scGroup.slice(0, 3), scGroup.length );
        form.fillOnly("rgb(255,0,0)").polygon(Curve.bspline( scGroup, 10, 1));
