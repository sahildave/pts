...
(function() {
    ...
    var circleMap = [];
    var lastSavedCircle = [];
    var createCircle = (key, dir, startNew) => {
    ...
    space.add({          
        start:( bound ) => { 
            createCircle(KEY_SLANT_TOP, dirSlantUp, true);
            createCircle(KEY_HORIZ, dirHoriz, false);
            createCircle(KEY_SLANT_BOTTOM, dirSlantDown, false);
        },
